...
@section('main-content')
    ...
    <a href="{{ route('bendahara-kas.create') }}" class="btn btn-primary mb-3">
        ...
        <tbody>
            ...
            @foreach ($data as $d)
                <tr>
                    ...
                    <td>
                        <form action="{{ route('bendahara-kas.destroy', $d->getKey()) }}" method="post">
                            @method('DELETE')
                            @csrf
                            <a href="{{ route('bendahara-kas.edit', $d->getKey()) }}" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> Edit</a>
